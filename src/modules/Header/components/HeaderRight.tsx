...
export const HeaderRight: React.FC = () => {
    return (
        <div className="flex items-center gap-4 h-full pr-32">
            {/* pr-32 adds padding to avoid overlap with Window Close/Max/Min buttons which are absolute positioned */}
            ...
            <button className="flex items-center gap-2 group cursor-pointer hover:bg-gray-900 px-3 py-1.5 rounded-full transition-colors">
